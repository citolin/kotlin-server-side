...
public final class AccountsGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<accounts.GetAccountByIdRequest,
      accounts.AccountResponse> getGetAccountByIdMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getAccountById",
      requestType = accounts.GetAccountByIdRequest.class,
      responseType = accounts.AccountResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<accounts.GetAccountByIdRequest,
      accounts.AccountResponse> getGetAccountByIdMethod() {
    io.grpc.MethodDescriptor<accounts.GetAccountByIdRequest, accounts.AccountResponse> getGetAccountByIdMethod;
      ...
      synchronized (AccountsGrpc.class) {
        if ((getGetAccountByIdMethod = AccountsGrpc.getGetAccountByIdMethod) == null) {
          AccountsGrpc.getGetAccountByIdMethod = getGetAccountByIdMethod =
              io.grpc.MethodDescriptor.<accounts.GetAccountByIdRequest, accounts.AccountResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getAccountById"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  accounts.GetAccountByIdRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  accounts.AccountResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<accounts.CreateAccountRequest,
      accounts.AccountResponse> getCreateAccountMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "createAccount",
      requestType = accounts.CreateAccountRequest.class,
      responseType = accounts.AccountResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<accounts.CreateAccountRequest,
      accounts.AccountResponse> getCreateAccountMethod() {
    io.grpc.MethodDescriptor<accounts.CreateAccountRequest, accounts.AccountResponse> getCreateAccountMethod;
      ...
      synchronized (AccountsGrpc.class) {
        if ((getCreateAccountMethod = AccountsGrpc.getCreateAccountMethod) == null) {
          AccountsGrpc.getCreateAccountMethod = getCreateAccountMethod =
              io.grpc.MethodDescriptor.<accounts.CreateAccountRequest, accounts.AccountResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "createAccount"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  accounts.CreateAccountRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  accounts.AccountResponse.getDefaultInstance()))
  ...
  public static abstract class AccountsImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getAccountById(accounts.GetAccountByIdRequest request,
        io.grpc.stub.StreamObserver<accounts.AccountResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetAccountByIdMethod(), responseObserver);
    }

    /**
     */
    public void createAccount(accounts.CreateAccountRequest request,
        io.grpc.stub.StreamObserver<accounts.AccountResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                accounts.GetAccountByIdRequest,
  ...
  public static final class AccountsBlockingStub extends io.grpc.stub.AbstractBlockingStub<AccountsBlockingStub> {
    ...
    /**
     */
    public accounts.AccountResponse getAccountById(accounts.GetAccountByIdRequest request) {
    ...
    /**
     */
    public accounts.AccountResponse createAccount(accounts.CreateAccountRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class AccountsFutureStub extends io.grpc.stub.AbstractFutureStub<AccountsFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<accounts.AccountResponse> getAccountById(
        accounts.GetAccountByIdRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<accounts.AccountResponse> createAccount(
        accounts.CreateAccountRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ACCOUNT_BY_ID:
          serviceImpl.getAccountById((accounts.GetAccountByIdRequest) request,
              (io.grpc.stub.StreamObserver<accounts.AccountResponse>) responseObserver);
          break;
        case METHODID_CREATE_ACCOUNT:
          serviceImpl.createAccount((accounts.CreateAccountRequest) request,
              (io.grpc.stub.StreamObserver<accounts.AccountResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AccountsBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return accounts.AccountsProto.getDescriptor();
    }
